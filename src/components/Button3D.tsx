...
const Button3D = () => {
  return (
    <div>
      <button className="relative p-0 w-[200px] h-[200px] border-4 border-[#888888] rounded-sm bg-[#f4f5f6] shadow">
        <div className="button__content">
          ...
          <p className="button__text">command</p>
        </div>
      </button>

      <p className="credits">
        Thanks{" "}
        <a href="https://twitter.com/pwign" className="credits__reference">
          Anh
        </a>{" "}
        for the inspiration
      </p>
